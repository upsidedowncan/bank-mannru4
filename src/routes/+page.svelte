...
<section class="hero min-h-[80vh] bg-gradient-to-r from-slate-50 to-blue-50">
	<div class="hero-content text-center max-w-4xl">
		<div>
			...
			<p class="text-xl text-gray-600 mb-8 max-w-2xl mx-auto font-light leading-relaxed">
...
<section id="services" class="py-20 bg-white">
	<div class="container mx-auto px-4">
		<div class="text-center mb-16">
			<h2 class="text-4xl font-light text-gray-900 mb-4 tracking-tight">Банковские услуги</h2>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
			<div class="card bg-white border border-gray-200 hover:shadow-lg transition-shadow">
				<div class="card-body">
					...
					<h3 class="card-title text-xl mb-3">Банковские карты</h3>
					<p class="text-gray-600 mb-4">Дебетовые и кредитные карты с кэшбэком до 5% и льготным периодом</p>
			...
			<div class="card bg-white border border-gray-200 hover:shadow-lg transition-shadow">
				<div class="card-body">
					...
					<h3 class="card-title text-xl mb-3">Ипотечное кредитование</h3>
					<p class="text-gray-600 mb-4">Ипотека от 4.5% годовых с минимальным первоначальным взносом</p>
					<div class="card-actions">
						<button class="btn btn-outline btn-sm">Подробнее</button>
					</div>
				</div>
			...
			<div class="card bg-white border border-gray-200 hover:shadow-lg transition-shadow">
				<div class="card-body">
					...
					<h3 class="card-title text-xl mb-3">Инвестиции</h3>
					<p class="text-gray-600 mb-4">Инвестиционные продукты и управление портфелем</p>
					<div class="card-actions">
						<button class="btn btn-outline btn-sm">Подробнее</button>
					</div>
				</div>
			...
			<div class="card bg-white border border-gray-200 hover:shadow-lg transition-shadow">
				<div class="card-body">
					...
					<h3 class="card-title text-xl mb-3">Корпоративное обслуживание</h3>
					<p class="text-gray-600 mb-4">Расчетно-кассовое обслуживание и кредитование бизнеса</p>
					<div class="card-actions">
						<button class="btn btn-outline btn-sm">Подробнее</button>
					</div>
				</div>
			...
			<div class="card bg-white border border-gray-200 hover:shadow-lg transition-shadow">
				<div class="card-body">
					...
					<h3 class="card-title text-xl mb-3">Страхование</h3>
					<p class="text-gray-600 mb-4">Страхование жизни, имущества и автотранспорта</p>
					<div class="card-actions">
						<button class="btn btn-outline btn-sm">Подробнее</button>
					</div>
				</div>
			...
			<div class="card bg-white border border-gray-200 hover:shadow-lg transition-shadow">
				<div class="card-body">
					...
					<h3 class="card-title text-xl mb-3">Депозиты</h3>
					<p class="text-gray-600 mb-4">Выгодные условия размещения средств до 8% годовых</p>
					<div class="card-actions">
						<button class="btn btn-outline btn-sm">Подробнее</button>
					</div>
				</div>
...
<section id="about" class="py-20 bg-gray-50">
	<div class="container mx-auto px-4">
		<div class="text-center mb-16">
			<h2 class="text-4xl font-light text-gray-900 mb-4 tracking-tight">Наши преимущества</h2>
			<p class="text-lg text-gray-600 max-w-2xl mx-auto font-light">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
			<div class="text-center">
				...
				<p class="text-gray-600">Высокие рейтинги надежности и страхование вкладов</p>
			</div>
			...
			<div class="text-center">
				...
				<p class="text-gray-600">Мгновенные переводы и быстрое рассмотрение заявок</p>
			</div>
			...
			<div class="text-center">
				...
				<p class="text-gray-600">Современное мобильное приложение и интернет-банк</p>
			</div>
			...
			<div class="text-center">
				...
				<p class="text-gray-600">Персональный подход и круглосуточная поддержка</p>
			</div>
		</div>
	</div>
</section>
...
<section class="py-20 bg-gray-900 text-white">
	<div class="container mx-auto px-4 text-center">
		<div class="max-w-2xl mx-auto">
			<Icon icon="mdi:email-newsletter" class="w-16 h-16 mx-auto mb-6 text-accent" />
			<h2 class="text-3xl font-bold mb-4">Будьте в курсе новостей</h2>
			<p class="text-lg mb-8 text-gray-300">
				Получайте информацию о новых продуктах, изменениях тарифов и специальных предложениях
			</p>
		...
		<div class="grid grid-cols-1 md:grid-cols-4 gap-8">
			...
			<div class="col-span-1 md:col-span-2">
				...
				<p class="text-gray-300 mb-4 max-w-md">
					...
					Предоставляем полный спектр банковских услуг для частных лиц и бизнеса.
				</p>

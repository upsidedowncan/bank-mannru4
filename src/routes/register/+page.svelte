...
>
  ...
  <div
    class="w-full lg:w-1/2 bg-white flex flex-col justify-center p-8 lg:p-12 overflow-y-auto overflow-x-hidden"
  >
    <!-- Mobile Logo -->
    ...
    <div class="max-w-md mx-auto w-full max-w-full">
      <div class="mb-8">
        ...
        <p class="text-gray-600 font-light">
          Откройте банковский счет за несколько минут
        </p>
      </div>
      ...
      <form on:submit|preventDefault={handleRegister} class="space-y-5">
        ...
        <div class="form-control">
          <label class="label cursor-pointer justify-start space-x-3">
            ...
            />
            <span
              class="label-text text-sm text-gray-600 leading-relaxed font-light"
            >
              Я согласен с <a
                href="/terms"
                class="text-primary hover:text-primary-focus font-medium"
                >условиями обслуживания</a
              >
              и
              <a
                href="/privacy"
